...
안녕하세요! 이 프로젝트는 사용자와 관리자 권한에 따라 책을 사고 팔고, 관리할 수 있는 **온라인 서점**입니다. 포트폴리오용으로 제작된 이 프로젝트는 프론트엔드와 백엔드가 긴밀하게 연동되어 있으며, 최신 기술 스택을 활용하여 구현되었습니다. 기존에 jQuery와 바닐라 자바스크립트로 작성되었던 오픈소스 부트스트랩을 **React**로 마이그레이션하여 더 현대적이고 효율적인 개발 환경을 조성하였습니다.
...
- **Bootstrap → React 마이그레이션:** 기존 jQuery 및 바닐라 자바스크립트 기반 부트스트랩을 React로 전환하여 현대적인 개발 환경과 향상된 성능을 구현.
...
### 홈 페이지
<p align="center">
  <img src="screenshots/Homepage.png" alt="홈 페이지" width="600"/>
</p>
<p align="center"><em>홈 페이지입니다. 슬라이더에 React Slick을 이용하였고 REST 방식으로 책 목록을 백엔드로부터 응답받아 표시합니다.</em></p>

<p align="center">
  <img src="screenshots/Homepage2.png" alt="홈 페이지 2" width="600"/>
</p>

<p align="center">
  <img src="screenshots/Homepage3.png" alt="홈 페이지 3" width="600"/>
</p>
<p align="center"><em>추가적인 홈 페이지 레이아웃입니다.</em></p>

### 관리자 대시보드
<p align="center">
  <img src="screenshots/image.png" alt="관리자 대시보드" width="600"/>
</p>
<p align="center"><em>관리자 권한이 있다면 책과 유저의 CRUD 작업이 가능합니다.</em></p>

<p align="center">
  <img src="screenshots/image2.png" alt="관리자 대시보드 2" width="600"/>
</p>
<p align="center"><em>추가적인 관리자 기능 화면입니다.</em></p>

<p align="center">
  <img src="screenshots/image5.png" alt="관리자 대시보드 3" width="600"/>
</p>

### 회원 관리
<p align="center">
  <img src="screenshots/image4.png" alt="회원 관리" width="600"/>
</p>
...
### 비회원 기능
<p align="center">
  <img src="screenshots/image3.png" alt="비회원 기능" width="600"/>
</p>

<p align="center">
  <img src="screenshots/image7.png" alt="로그인 화면" width="600"/>
</p>
...
<p align="center">
  <img src="screenshots/image6.png" alt="쇼핑 페이지" width="600"/>
</p>
